...
_LOCATIONEVENTSERVICE = _descriptor.ServiceDescriptor(
  name='LocationEventService',
  full_name='LocationEventService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Create',
    full_name='LocationEventService.Create',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_LOCATIONEVENTSERVICE)

DESCRIPTOR.services_by_name['LocationEventService'] = _LOCATIONEVENTSERVICE
