...
![](/nd064-c3-observability-metrics-dashboard/answer-img/services.PNG)

## Setup the Jaeger and Prometheus source
*TODO:* Expose Grafana to the internet and then setup Prometheus as a data source. Provide a screenshot of the home page after logging into Grafana.

![](/nd064-c3-observability-metrics-dashboard/answer-img/grafana-login.PNG)

## Create a Basic Dashboard
*TODO:* Create a dashboard in Grafana that shows Prometheus as a source. Take a screenshot and include it here.

![](/nd064-c3-observability-metrics-dashboard/answer-img/basic-dashboard.PNG)
...
![](/nd064-c3-observability-metrics-dashboard/answer-img/slis-dashboard.PNG)

## Tracing our Flask App
*TODO:*  We will create a Jaeger span to measure the processes on the backend. Once you fill in the span, provide a screenshot of it here.

![](/nd064-c3-observability-metrics-dashboard/answer-img/jaeger_trace.PNG)

## Jaeger in Dashboards
*TODO:* Now that the trace is running, let's add the metric to our current Grafana dashboard. Once this is completed, provide a screenshot of it here.

![](/nd064-c3-observability-metrics-dashboard/answer-img/jaeger_grafana.PNG)
...
![](/nd064-c3-observability-metrics-dashboard/answer-img/final-dashboard.PNG)
